...
export default function CreateFinancialRecordModal({ onRecordCreated }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            console.error("שגיאה ביצירת רישום כספי:", error);
        }
    };
    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent>
                <DialogHeader>
                    <DialogTitle style={{ fontFamily: 'Heebo' }}>הוספת רישום כספי חדש</DialogTitle>
                </DialogHeader>
                <form onSubmit={handleSubmit} className="space-y-4 pt-4">
                    ...
                    <div className="flex justify-end gap-4 pt-4">
                        ...
                        <Button type="submit" className="bg-[#67BF91] hover:bg-[#5AA880]">שמור רישום</Button>
                    </div>
                </form>
            </DialogContent>
        </Dialog>
